...
\captionbelow{Úvodní pohled na GNOME Shell} \label{fig:shell-a}
\end{center}
\end{figure}
...
%\captionbelow{Nabídka aplikace} \label{fig:menu-aplikace}
%\end{center}
%\end{figure}
...
%\captionbelow{Hodiny a kalendář} \label{fig:kalendar}
%\end{center}
%\end{figure}
...
%\captionbelow{Nabídka uživatele} \label{fig:menu}
%\end{center}
%\end{figure}
...
\captionbelow{Obrazovka Činností} \label{fig:shell-b}
\end{center}
\end{figure}
...
%\captionbelow{Práce s aplikacemi v Dashi} \label{fig:dash-b}
%\end{center}
%\end{figure}
...
%\captionbelow{Zobrazení všech aplikací} \label{fig:dash-a}
%\end{center}
%\end{figure}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.85\textwidth]{img/vyhledavani}
%\captionbelow{Integrované vyhledávání} \label{fig:vyhledavani}
%\end{center}
%\end{figure}
...
\captionbelow{Uživatelská a systémová nastavení} \label{fig:nastaveni}
%\end{center}
%\end{figure}
\bigskip
%\begin{figure}[t]
...
\captionbelow{Správa software ve Fedoře} \label{fig:software}
\end{center}
\end{figure}

\section*{Instalace nového software}
\sloppy{Fedora už v~základu obsahuje mnoho potřebných aplikací (webový prohlížeč \emph{Mozilla~Firefox}, kancelářský balík \emph{LibreOffi\-ce}, multimediální přehrávač \emph{Totem}} a desítky dalších). Co když ale potřebujeme více programů? Ne všechen software může být zahrnut do výchozí instalace systému, je ale dostupný v~tzv. repozitářích, z~nichž lze daný program jednoduše stáhnout. Repozitář je tvořen sadou serverů a jejich zrcadel, kde jsou umístěny balíky s~různými aplikacemi a knihovnami. Slyšeli jste o~\uv{appstore} na různých mobilních platformách? Pak jste velice blízko, základní princip je stejný. Chcete nějaký program stáhnout z~webu a nainstalovat? Zkuste se nejprve podívat, zda není k~dispozici v~repozitářích. Na Linuxu se tak instaluje naprostá většina aplikací. Jak tedy na to?
